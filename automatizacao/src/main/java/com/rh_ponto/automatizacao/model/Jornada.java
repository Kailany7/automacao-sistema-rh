...
public class Jornada {
    ...
    public String getDescricao_jornada() { return descricao_jornada; }
    public void setDescricao_jornada(String descricao_jornada) { this.descricao_jornada = descricao_jornada; }
